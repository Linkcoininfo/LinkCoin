...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\LinkCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\LinkCoin
    // Mac: ~/Library/Application Support/LinkCoin
    // Unix: ~/.LinkCoin
#ifdef WIN32
    // Windows
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                if (!fMatch)
                {
                    ...
                    printf("*** %s\n", strMessage.c_str());
                    uiInterface.ThreadSafeMessageBox(strMessage+" ", string("LinkCoin"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION);
                }
            }
        }
        if (fDebug) {
