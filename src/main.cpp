...
int64 nChainStartTime = 1501257600;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)
  {                nSubsidy = 33600000 * COIN;
  // 1 billion coins, that all pow coins
  return nSubsidy + nFees;
  }

    nSubsidy >>= (nHeight / 252000);
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Jul 29, 2017, Putin Signs Treaty To Add Crimea To Map.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0xa39b733f123f53233a9b59816f25699cedb2fe8a4f071e1788c878d4b8d1ff89"));
